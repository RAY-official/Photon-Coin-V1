...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1de1; // addresses start with "XRY1"
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(750000000);
...
const char     CRYPTONOTE_NAME[]                             = "EGYPT";
...
const int      P2P_DEFAULT_PORT                              = 2550;
const int      RPC_DEFAULT_PORT                              = 2551;
